                                ...
                                <tbody>
                                    <?php foreach ($employees as $employe) { ?>
                                      <tr class="lignecolor">
                                        ...
                                        <td>
                                            <a href="modifieremployes.php?idemp=<?php echo $employe['idemp'] ?>"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                            <a onclick="return confirm('Etes vous sûr de vouloir archiver l\'employé')" href="supprimeremployes.php?idemp=<?php echo $employe['idemp'] ?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
