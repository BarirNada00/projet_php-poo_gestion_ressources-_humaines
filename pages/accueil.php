...
<div class="container">
  ...
  <div class="info">
    <h1>Rh<span style="color:#ff4321">ecrute</span>&#63;</h1>
   ...
   <a href="candidature.php" role="button">postuler &raquo;</a>
    ...
    <div class="footer-content">
        <h3>Contact</h3>
        <p>
        Al ABRAR 3 complexe Doha route casa, Marrakech<br/>
                  40000 / Marrakech<br/>
                N° Tél : 06 15 24 26 92 <br/>
                Rhecrute@gmail.com<br/>
        </p>
        <ul class="social-links">
        <li><a href="https://www.facebook.com/nada.barir"><i class="fab fa-facebook-f"></i></a></li>
        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
        <li><a href="https://www.instagram.com/nada_barir/"><i class="fab fa-instagram"></i></a></li>
        <li><a href="#"><i class="fab fa-youtube"></i></a></li>
        <li><a href="https://www.linkedin.com/in/nada-barir-a53071193/"><i class="fab fa-linkedin-in"></i></a></li>
        </ul>
        </div>
    <div class="footer-bottom">
        <p>copyright &copy;2023 contact. designed by <span>nada barir</span></p>
        </div>
