<?php
  ...
  $candidats=$resultatR->fetch();
    ...
    header("Content-Type: $ctype");//Détermine le type de contenu (Content-Type) en fonction de l'extension du fichier (par exemple, "application/pdf" pour les fichiers PDF).
